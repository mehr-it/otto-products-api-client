# MehrIt\OttoProductsApiClient\CategoriesApi
...
# **getCategoryGroups**
> \MehrIt\OttoProductsApiClient\Model\CategoryGroups getCategoryGroups($page, $limit)
...
$apiInstance = new MehrIt\OttoProductsApiClient\Api\CategoriesApi(
...
[**\MehrIt\OttoProductsApiClient\Model\CategoryGroups**](../Model/CategoryGroups.md)
