...
'attributes' => '\MehrIt\OttoProductsApiClient\Model\Attribute[]'    ];
...
'attributes' => 'getAttributes'    ];
     ...
     * Sets description
     *
     * @param string $description Represents a textual description of a product variant. May contain HTML elements. Relevant for SEO.
     *
     * @return $this
     */
     ...
     * Gets attributes
     *
     * @return \MehrIt\OttoProductsApiClient\Model\Attribute[]
     */
     ...
     * Sets attributes
     *
     * @param \MehrIt\OttoProductsApiClient\Model\Attribute[] $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return $this
     */
