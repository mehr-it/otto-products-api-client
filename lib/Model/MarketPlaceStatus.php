...
class MarketPlaceStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'sku' => 'string',
'status' => 'string',
'errors' => '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusError[]',
'links' => '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusLink[]',
'last_modified' => 'int'    ];
...
self::STATUS_INACTIVE,        ];
     ...
     * Gets errors
     *
     * @return \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusError[]
     */
     ...
     * Sets errors
     *
     * @param \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusError[] $errors errors that occurred when processing the variation
     *
     * @return $this
     */
     ...
     * Gets links
     *
     * @return \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusLink[]
     */
     ...
     * Sets links
     *
     * @param \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusLink[] $links contains the link to the partner variation data and to the product in OTTO shop
     *
     * @return $this
     */
