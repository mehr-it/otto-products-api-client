...
/**
 * MarketPlaceStatusError Class Doc Comment
 *
 * @category Class
 * @package  MehrIt\OttoProductsApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketPlaceStatusError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MarketPlaceStatusError';
...
'title' => 'getTitle'    ];
     ...
     * Sets code
     *
     * @param string $code code to identify the error
     *
     * @return $this
     */
