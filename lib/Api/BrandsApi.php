...
class BrandsApi
{
     ...
     * @return \MehrIt\OttoProductsApiClient\Model\Brand[]
     */
    public function getBrands()
    {
        list($response) = $this->getBrandsWithHttpInfo();
        return $response;
    }
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\Brand[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandsWithHttpInfo()
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\Brand[]';
        $request = $this->getBrandsRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\Brand[]',
     ...
     */
    public function getBrandsAsync()
    {
        return $this->getBrandsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBrandsAsyncWithHttpInfo()
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\Brand[]';
        $request = $this->getBrandsRequest();
