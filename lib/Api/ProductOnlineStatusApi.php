...
class ProductOnlineStatusApi
{
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoProductsApiClient\Model\OnlineStatus
     */
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\OnlineStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationOnlineStatusWithHttpInfo($sku)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\OnlineStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\OnlineStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * DEPRECATED - please use the corresponding active-status endpoint instead.
     *
     * @param  \MehrIt\OttoProductsApiClient\Model\OnlineStatusListRequest $body body (optional)
     ...
     * DEPRECATED - please use the corresponding active-status endpoint instead.
     *
     * @param  \MehrIt\OttoProductsApiClient\Model\OnlineStatusListRequest $body (optional)
     * @param  \DateTime $x_request_timestamp Holds the client side update request timestamp (optional)
     *
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
