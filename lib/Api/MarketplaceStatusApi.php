...
class MarketplaceStatusApi
{
     ...
     * @return \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatus
     */
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketPlaceStatusWithHttpInfo($sku)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatus',
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusApiResult
     */
    public function getMarketPlaceStatusList($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null, $market_place_status = null)
    {
        list($response) = $this->getMarketPlaceStatusListWithHttpInfo($sku, $product_name, $category, $brand, $page, $limit, $market_place_status);
        return $response;
    }
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusApiResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketPlaceStatusListWithHttpInfo($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null, $market_place_status = null)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusApiResult';
        $request = $this->getMarketPlaceStatusListRequest($sku, $product_name, $category, $brand, $page, $limit, $market_place_status);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusApiResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMarketPlaceStatusListAsync($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null, $market_place_status = null)
    {
        return $this->getMarketPlaceStatusListAsyncWithHttpInfo($sku, $product_name, $category, $brand, $page, $limit, $market_place_status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMarketPlaceStatusListAsyncWithHttpInfo($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null, $market_place_status = null)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\MarketPlaceStatusApiResult';
        $request = $this->getMarketPlaceStatusListRequest($sku, $product_name, $category, $brand, $page, $limit, $market_place_status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMarketPlaceStatusListRequest($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null, $market_place_status = null)
    {
