...
class CategoriesApi
{
     ...
     * @return \MehrIt\OttoProductsApiClient\Model\CategoryGroups
     */
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\CategoryGroups, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryGroupsWithHttpInfo($page = null, $limit = null)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\CategoryGroups';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\CategoryGroups',
