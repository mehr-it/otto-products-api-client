...
class ProductActiveStatusApi
{
     ...
     * @return \MehrIt\OttoProductsApiClient\Model\OnlineStatusListResponse
     */
    public function getActiveStatus($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        list($response) = $this->getActiveStatusWithHttpInfo($sku, $product_name, $category, $brand, $page, $limit);
        return $response;
    }
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\OnlineStatusListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActiveStatusWithHttpInfo($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\OnlineStatusListResponse';
        $request = $this->getActiveStatusRequest($sku, $product_name, $category, $brand, $page, $limit);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\OnlineStatusListResponse',
     ...
     */
    public function getActiveStatusAsync($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        return $this->getActiveStatusAsyncWithHttpInfo($sku, $product_name, $category, $brand, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActiveStatusAsyncWithHttpInfo($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\OnlineStatusListResponse';
        $request = $this->getActiveStatusRequest($sku, $product_name, $category, $brand, $page, $limit);
     ...
     */
    protected function getActiveStatusRequest($sku = null, $product_name = null, $category = null, $brand = null, $page = null, $limit = null)
    {
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoProductsApiClient\Model\ActiveStatus
     */
     ...
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoProductsApiClient\Model\ActiveStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationActiveStatusWithHttpInfo($sku)
    {
        $returnType = '\MehrIt\OttoProductsApiClient\Model\ActiveStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoProductsApiClient\Model\ActiveStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \MehrIt\OttoProductsApiClient\Model\ActiveStatusListRequest $body body (optional)
     ...
     * Update the active status of your product variations and get a process-id to query results. Replaces corresponding online-status endpoint which now is marked as deprecated.
     *
     * @param  \MehrIt\OttoProductsApiClient\Model\ActiveStatusListRequest $body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \MehrIt\OttoProductsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
